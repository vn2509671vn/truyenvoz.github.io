<div class="col-md-12 col-xs-12">
    <div class="x_panel no-border">
        <div class="x_title">
            <h2>Thêm truyện mới</small></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            <br />
            <form action="<?php echo base_url('product/add-new'); ?>" method="post" class="form-horizontal"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <input type="text" class="form-control" required name="name" value="<?php echo set_value('name'); ?>"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
						<textarea name="description" id="description" class="form-control" rows="10" cols="50"><?php echo set_value('description'); ?></textarea>
