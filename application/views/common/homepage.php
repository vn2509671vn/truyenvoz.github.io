        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Tổng Hợp Những Câu Truyện Hay</h1>
              <span class="subheading">Đây là những câu chuyện có thật, được kể lại sau khi trải nghiệm thực tế.</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <!-- Pager -->
          <div class="clearfix">
            <!-- <a class="btn btn-primary float-right" href="#">Xem thêm &rarr;</a> -->
            <div class="paging">
              <?php echo $parinator; ?>
            </div>
          </div>
